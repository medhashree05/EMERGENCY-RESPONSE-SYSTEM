    ...
    try {
      ...
      mediaRecorderRef.current.onstop = async () => {
        ...
        try {
          ...
          console.log(`Sending audio file: ${fileName} (${mimeType}), size: ${audioFile.size} bytes`);
      ...
      onSendAudio("⚠️ Microphone access denied. Please check your browser permissions.");
    }
  };
